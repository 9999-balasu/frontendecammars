...
const PlaceOrder = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-14 min-h-[80vh] border-top'>
      {/*---------------- Left Side ----------- */}
...
<div className='flex gap-3'>
  <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type='number' placeholder='ZipCod'/>
