...
<Link to='/'><img src={assets.th22} className='w-36' alt="logo"/></Link>
...
<img onClick={()=>setShowSearch(true)} src={assets.search} className='w-10 cursor-pointer' alt=''/>
...
<img onClick={()=>setVisible(true)} src={assets.menu} className='w-10 cursor-pointer sm:hidden' alt=''/>
 ...
 <div className={`absolute top right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
